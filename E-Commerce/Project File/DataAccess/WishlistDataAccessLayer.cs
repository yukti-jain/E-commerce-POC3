...
namespace eCommerce.DataAccess
{
    public class WishlistDataAccessLayer : IWishlistService
    {
        ...
        public WishlistDataAccessLayer(AppDBContext dbContext)
        {
        ...
        public void ToggleWishlistItem(int userId, int productId)
        {
            ...
            WishlistItems existingWishlistItem = _dbContext.WishlistItems.FirstOrDefault(x => x.ProductId == productId && x.WishlistId == wishlistId);
