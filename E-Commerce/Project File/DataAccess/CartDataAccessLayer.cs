...
namespace eCommerce.DataAccess
{
    public class CartDataAccessLayer : ICartService
    {
        ...
        public CartDataAccessLayer(AppDBContext dbContext)
        {
        ...
        public void AddProductToCart(int userId, int productId)
        {
            ...
            CartItems existingCartItem = _dbContext.CartItems.FirstOrDefault(x => x.ProductId == productId && x.CartId == cartId);
        ...
        public void RemoveCartItem(int userId, int productId)
        {
            ...
            {
                string cartId = GetCartId(userId);
                CartItems cartItem = _dbContext.CartItems.FirstOrDefault(x => x.ProductId == productId && x.CartId == cartId);
